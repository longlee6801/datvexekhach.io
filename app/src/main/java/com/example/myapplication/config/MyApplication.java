...
public class MyApplication extends Application {
    ...
    public void onCreate() {
        ...
        if (!DataLocalManager.getIsFirst())
        {
            ...
            ThanhVien t1 = new ThanhVien("adminlee", "longleba0608@gmail.com");
            t1.setMatKhau("admin");
            t1.setSoDienThoai("0386496682");
            t1.setIdQuyenThanhVien(1);
            t1.setAvatar("https://f9-zpcloud.zdn.vn/9192093310976170948/a4fd78baa13c7062292d.jpg");


            ThanhVien t4 = new ThanhVien("longlee", "longlee0608@gmail.com");
            t4.setMatKhau("longlee");
